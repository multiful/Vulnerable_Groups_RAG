...
> **파일명**: FOLDER.md  
> **폴더 경로**: `frontend/src/components/cards`  
> **최종 수정일**: 2026-06-28  
> **문서 해시**: SHA256:TBD  
...
| 파일 | 역할 | 상태 |
|---|---|---|
| `CertJobCard.tsx` | 자격증 추천 카드 — 스켈레톤 로딩 + 난이도·합격률·LLM 연관성 + 대기업 채용공고 매칭 | 활성 |

## 4. 산출·연계

추천·로드맵 카드. `CertJobCard`는 `/recommendation` 페이지의 exec-panel 내 "대기업 채용공고 매칭" 섹션에서 사용.
